...
class I18n {
	...
	/**
	 * Translation strings for a specific domain read from the .
	 * mo or .po files
	 *
	 * @var array
	 */
	 ...
	 *        	Language to translate string to.
	...
	/**
	 * Clears the domains internal data array.
	 * Useful for testing i18n.
	 *
	 * @return void
	 */
	...
	/**
	 * Loads the binary .
	 * mo file and returns array of translations
	 *
	...
	/**
	 * Loads the text .
	 * po file and returns array of translations
	 *
	 * @param string $filename
