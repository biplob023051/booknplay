...
class PaginatorComponent extends Component {
	...
	/**
	 * Pagination settings.
	 * These settings control pagination at a general level.
	...
	/**
	 * A list of parameters users are allowed to set using request parameters.
	 * Modifying
	 ...
	 *        	List of allowed fields for ordering. This allows you to prevent ordering
	...
	public function paginate($object = null, $scope = array(), $whitelist = array()) {
		...
		$this->Controller->request ['paging'] = array_merge ( ( array ) $this->Controller->request ['paging'], array (
				$object->alias => $paging 
		) );
	 ...
	 *
	 * @param string $alias
	 *        	Model alias being paginated, if the general settings has a key with this value
	 ...
	 * If there are no settings for a specific model, the general settings
	 * will be used.
	 *
	 * @param string $alias
