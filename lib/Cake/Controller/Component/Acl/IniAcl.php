...
/**
 * IniAcl implements an access control system using an INI file.
 * An example
...
class IniAcl extends Object implements AclInterface {
	 ...
	 * acl.ini file.
	 * This path will be used to extract the string
	 ...
	 * INI file's section structure.
	 * Double-quote friendly.
	 *
