 ...
 * your application.
 * It provides methods for various tasks like:
 *
...
class SecurityComponent extends Component {
	...
	/**
	 * Form fields to exclude from POST validation.
	 * Fields can be unlocked
	...
	/**
	 * Whether to validate POST data.
	 * Set to false to disable for data coming from 3rd party
	 * services, etc.
	 *
	 * @var boolean
	 */
	...
	/**
	 * Whether to use CSRF protected forms.
	 * Set to false to disable CSRF protection on forms.
	 *
	 * @var boolean
	...
	/**
	 * Controls whether or not CSRF tokens are use and burn.
	...
	/**
	 * Component startup.
	 * All security checking happens here.
	 *
	...
	/**
	 * Black-hole an invalid request with a 400 error or custom callback.
	 * If SecurityComponent::$blackHoleCallback
	...
	public function blackHole(Controller $controller, $error = '') {
		...
		return $this->_callback ( $controller, $this->blackHoleCallback, array (
				$error 
		) );
	}
	...
	protected function _requireMethod($method, $actions = array()) {
		...
		$this->{'require' . $method} = (empty ( $actions )) ? array (
				'*' 
		) : $actions;
	}
