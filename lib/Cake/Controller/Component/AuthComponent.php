...
class AuthComponent extends Component {
	 ...
	 * Handles redirecting of invalid users, and processing
	 * of login form data.
	 *
	 * @param Controller $controller
	 *        	A reference to the instantiating controller object
	 ...
	 * objects will have their getUser() methods called.
	...
	/**
	 * Component shutdown.
	 * If user is logged in, wipe out redirect.
	 *
	 * @param Controller $controller
	...
	/**
	 * Set a flash message.
	 * Uses the Session component, and values from AuthComponent::$flash.
	 *
