 ...
 * Provides the ability to authorize using a controller callback.
...
class ControllerAuthorize extends BaseAuthorize {
	...
	/**
	 * Get/set the controller this authorize object will be working with.
	 * Also checks that isAuthorized is implemented.
	 *
