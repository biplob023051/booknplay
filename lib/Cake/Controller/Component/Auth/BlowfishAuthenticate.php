 ...
 * Provides the ability to authenticate using POST data using Blowfish
...
class BlowfishAuthenticate extends FormAuthenticate {
	 ...
	 * Will use the `settings.userModel`, and `settings.fields`
	...
	public function authenticate(CakeRequest $request, CakeResponse $response) {
		...
		$password = Security::hash ( $request->data [$model] [$fields ['password']], 'blowfish', $user [$fields ['password']] );
