...
/**
 * Base class for an individual Component.
 * Components provide reusable bits of
...
class Component extends Object {
	...
	public function __get($name) {
		if (isset ( $this->_componentMap [$name] ) && ! isset ( $this->{$name} )) {
			$settings = array_merge ( ( array ) $this->_componentMap [$name] ['settings'], array (
					'enabled' => false 
			) );
	 ...
	 * Allows you to replace the URL that will
