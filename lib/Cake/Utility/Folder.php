...
class Folder {
	 ...
	 *
	 * @var integer http://book.cakephp.org/2.0/en/core-utility-libraries/file-folder.html#Folder::$mode
	 */
	public $mode = 0755;
	 ...
	 *
	 * @param boolean $sort
	 *        	Whether you want the results sorted, set this and the sort property
	 *        	to false to get unsorted results.
	 * @param array|boolean $exceptions
	 ...
	 * @param array|boolean $exceptions
	 *        	Either an array of files/folder to exclude
