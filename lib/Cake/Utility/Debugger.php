...
class Debugger {
	...
	/**
	 * Templates used when generating trace or error strings.
	 * Can be global or indexed by the format
	 ...
	 * The log entry will contain a stack trace from where it was called.
	...
	public static function showError($code, $description, $file = null, $line = null, $context = null) {
		...
		$data = compact ( 'level', 'error', 'code', 'description', 'file', 'path', 'line', 'context' );
	...
	public static function trace($options = array()) {
		...
		for($i = $options ['start']; $i < $count && $i < $options ['depth']; $i ++) {
			...
			if ($options ['format'] === 'points' && $trace ['file'] !== '[internal]') {
				...
				$back [] = String::insert ( $tpl, $trace, array (
						'before' => '{:',
						'after' => '}' 
				) );
			}
	...
	protected static function _highlight($str) {
		...
		if ($added) {
			$highlight = str_replace ( '&lt;?php&nbsp;<br />', '', $highlight );
		}
		return $highlight;
	}
	 ...
	 * Filters out keys used in datasource configuration.
	 *
	 ...
	 *
	 * @param string $format
	 *        	Format to use, including 'js' for JavaScript-enhanced HTML, 'html' for
	...
	public function outputError($data) {
		...
		foreach ( $infoData as $key => $value ) {
			...
			$info .= String::insert ( $tpl [$key], array (
					$key => $value 
			) + $data, $insertOpts );
		}
		$links = implode ( ' ', $links );
