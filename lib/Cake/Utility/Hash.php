...
class Hash {
	 ...
	 *        	The path being searched for. Either a dot
	 ...
	 * `$valuePath` as path to get the values.
	 * If `$valuePath` is not specified, all values will be initialized
	...
	/**
	 * Counts the dimensions of *all* array elements.
	 * Useful for finding the maximum
