...
class ClassRegistry {
	 ...
	 *        	as a string or a single key => value array instance will be created,
	 *        	stored in the registry and returned.
	 * @param boolean $strict
	 *        	if set to true it will return false if the class was not found instead
	 ...
	 * @param array $param
	 *        	The parameter that will be passed to object constructors when objects
	 *        	of $type are created
