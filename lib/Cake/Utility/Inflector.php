...
class Inflector {
	...
	/**
	 * Clears Inflectors inflected value caches.
	 * And resets the inflection
	...
	/**
	 * Returns corresponding table name for given model $className.
	 * ("people" for the model class "Person").
	 *
