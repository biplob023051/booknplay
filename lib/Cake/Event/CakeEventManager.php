 ...
 * data to them, and firing them in the correct order, when associated events are triggered.
 * You
...
class CakeEventManager {
	 ...
	 * other managers were created.
	 * Usually for creating hook systems or inter-class
	 * communication
	 *
	 ...
	 * Listeners
	 *
	 * @param callback|CakeEventListener $callable
	 *        	PHP valid callback type or instance of CakeEventListener to be called
	 ...
	 *        	The event unique identifier name with which the callback will be associated. If $callable
	 *        	is an instance of CakeEventListener this argument will be ignored
	 *        	
	 * @param array $options
	 *        	used to set the `priority` and `passParams` flags to the listener.
	 ...
	 * @param CakeEventListener $object
	 *        	The handler object
	 * @return callback
	 */
