...
/**
 * This abstract class represents a filter to be applied to a dispatcher cycle.
 * It acts as as
...
abstract class DispatcherFilter implements CakeEventListener {
	 ...
	 *        	container object having the `request`, `response` and `additionalParams`
	 ...
	 *
	 * @param CakeEvent $event
	 *        	container object having the `request` and `response`
	 *        	keys in the data property.
