...
/**
 * Dispatcher converts Requests into controller actions.
 * It uses the dispatched Request
...
class Dispatcher implements CakeEventListener {
	 ...
	 * created.
	 * Attaches the default listeners and filters
	 *
	...
	public function implementedEvents() {
		return array (
				'Dispatcher.beforeDispatch' => 'parseParams' 
		);
	}
