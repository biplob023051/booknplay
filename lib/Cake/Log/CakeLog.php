...
class CakeLog {
	 ...
	 *
	 * @param string $key
	 *        	The keyname for this logger, used to remove the
	 *        	logger later.
	 * @param array $config
	 ...
	 * Once a stream has been removed
	...
	/**
	 * Enable stream.
	 * Streams that were previously disabled
	 ...
	 *        	Type of message being written. When value is an integer
	 ...
	 *        	The scope(s) a log message is being created in.
