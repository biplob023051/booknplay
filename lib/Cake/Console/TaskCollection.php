...
class TaskCollection extends ObjectCollection {
	...
	/**
	 * Loads/constructs a task.
	 * Will return the instance in the collection
	...
	public function load($task, $settings = array()) {
		...
		$this->_loaded [$name] = new $taskClass ( $this->_Shell->stdout, $this->_Shell->stderr, $this->_Shell->stdin );
		return $this->_loaded [$name];
	}
}
