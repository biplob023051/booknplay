...
class CommandListShell extends AppShell {
	...
	protected function _getShellList() {
		...
		$shellList = array_fill_keys ( $plugins, null ) + array (
				'CORE' => null,
				'app' => null 
		);
	...
	public function getOptionParser() {
		...
		return $parser->description ( __d ( 'cake_console', 'Get the list of available shells for this CakePHP application.' ) )->addOption ( 'sort', array (
