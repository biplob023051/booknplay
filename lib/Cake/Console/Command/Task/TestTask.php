...
class TestTask extends BakeTask {
	...
	public function bake($type, $className) {
		...
		$this->Template->set ( compact ( 'className', 'methods', 'type', 'fullClassName', 'mock', 'realType', 'preConstruct', 'postConstruct', 'construction', 'uses' ) );
	...
	/**
	 * Interact with the user and get their chosen type.
	 * Can exit the script.
	 *
	 ...
	 *
	 * @param string $type
	 *        	The type the class having a test
	 *        	generated for is in.
	...
	protected function _processController($subject) {
		...
		$models = array (
				Inflector::classify ( $subject->name ) 
		);
	 ...
	 * resolve the suffixes for controllers
	...
	public function getOptionParser() {
		...
		return $parser->description ( __d ( 'cake_console', 'Bake test case skeletons for classes.' ) )->addArgument ( 'type', array (
