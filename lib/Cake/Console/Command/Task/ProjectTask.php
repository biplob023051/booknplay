...
class ProjectTask extends AppShell {
	 ...
	 * finds the app directory in it.
	 * Then it calls bake() with that information.
	 *
	 * @return mixed
	 */
	 ...
	 * and if not found asks the user for a path.
	...
	public function getPrefix() {
		...
		if ($this->interactive) {
			$this->hr ();
			$this->out ( __d ( 'cake_console', 'You need to enable %s in %s to use prefix routing.', 'Configure::write(\'Routing.prefixes\', array(\'admin\'))', '/app/Config/core.php' ) );
	...
	public function getOptionParser() {
		...
		return $parser->description ( __d ( 'cake_console', 'Generate a new CakePHP project skeleton.' ) )->addArgument ( 'name', array (
