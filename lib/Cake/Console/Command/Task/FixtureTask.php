...
class FixtureTask extends BakeTask {
	...
	public function getOptionParser() {
		...
		return $parser->description ( __d ( 'cake_console', 'Generate fixtures for use with the test suite. You can use `bake fixture all` to bake all fixtures.' ) )->addArgument ( 'name', array (
	...
	/**
	 * Bake All the Fixtures at once.
	 * Will only bake fixtures for models that exist.
	 *
	 * @return void
	 */
	public function all() {
	...
	/**
	 * Interacts with the User to setup an array of import options.
	 * For a fixture.
	 *
	...
	public function importOptions($modelName) {
		...
		if ($doRecords === 'n') {
			...
			$fromTable = $this->in ( $prompt, array (
					'y',
					'n' 
			), 'n' );
