...
class ShellDispatcher {
	 ...
	 * if they are set.
	 * If they are not set, the default ConsoleErrorHandler will be
	 * used.
	 *
	 * @return void
	 */
	public function setErrorHandlers() {
		...
		if (empty ( $exception ['consoleHandler'] )) {
			$exception ['consoleHandler'] = array (
					$errorHandler,
					'handleException' 
			);
	...
	public function dispatch() {
		...
		throw new MissingShellMethodException ( array (
				'shell' => $shell,
				'method' => $command 
		) );
	}
	...
	/**
	 * Shows console help.
	 * Performs an internal dispatch to the CommandList Shell
	 *
	 * @return void
	 */
