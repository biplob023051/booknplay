...
class ConsoleInputOption {
	...
	/**
	 * Is the option a boolean option.
	 * Boolean options do not consume a parameter.
	 *
	 * @var boolean
	 */
	protected $_boolean;
	...
	public function __construct($name, $short = null, $help = '', $boolean = false, $default = '', $choices = array()) {
		...
		if (strlen ( $this->_short ) > 1) {
			throw new ConsoleException ( __d ( 'cake_console', 'Short option "%s" is invalid, short options must be one letter.', $this->_short ) );
		}
	}
