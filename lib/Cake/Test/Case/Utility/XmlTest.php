...
class XmlTest extends CakeTestCase {
	...
	public function testBuild() {
		...
		$this->assertEquals ( Xml::build ( $xml, array (
				'return' => 'domdocument' 
		) ), Xml::build ( file_get_contents ( $xml ), array (
				'return' => 'domdocument' 
		) ) );
		$this->assertEquals ( Xml::build ( $xml, array (
				'return' => 'simplexml' 
...
XML;
	...
	public function testSoap() {
		...
		$xmlRequest = Xml::fromArray ( $xml, array (
				'encoding' => null 
		) );
		$xmlText = <<<XML
<?xml version="1.0"?>
...
XML;
	...
	public function testCdata() {
		$xml = '<' . '?xml version="1.0" encoding="UTF-8"?>' . '<people><name><![CDATA[ Mark ]]></name></people>';
