...
class FolderTest extends CakeTestCase {
	...
	public function testChmod() {
		...
		$this->assertTrue ( $Folder->chmod ( $new, 0744, true, array (
				'skip_me.php',
				'test2' 
		) ) );
	...
	protected function _setupFilesystem() {
		...
		return compact ( 'path', 'folderOne', 'folderOneA', 'folderTwo', 'folderTwoB', 'folderThree', 'fileOne', 'fileOneA', 'fileTwo', 'fileTwoB' );
	}
