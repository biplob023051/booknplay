...
class ObjectCollectionTest extends CakeTestCase {
	...
	public function testUnload() {
		...
		$this->assertEquals ( array (
				'First',
				'Second' 
		), $result, 'loaded objects are wrong' );
		...
		$this->assertEquals ( array (
				'Second' 
		), $result, 'enabled objects are wrong' );
	}
	...
	public function testTrigger() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->will ( $this->returnValue ( true ) );
		$this->Objects->TriggerMockSecond->expects ( $this->once () )->method ( 'callback' )->will ( $this->returnValue ( true ) );
	...
	public function testTriggerWithDisabledObjects() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->will ( $this->returnValue ( true ) );
		$this->Objects->TriggerMockSecond->expects ( $this->never () )->method ( 'callback' )->will ( $this->returnValue ( true ) );
	...
	public function testTriggerWithCollectReturn() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->will ( $this->returnValue ( array (
				'one',
				'two' 
		) ) );
		$this->Objects->TriggerMockSecond->expects ( $this->once () )->method ( 'callback' )->will ( $this->returnValue ( array (
				'three',
				'four' 
		) ) );
		
		$result = $this->Objects->trigger ( 'callback', array (), array (
				'collectReturn' => true 
		) );
		$expected = array (
				array (
	...
	public function testTriggerWithBreak() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->will ( $this->returnValue ( false ) );
		$this->Objects->TriggerMockSecond->expects ( $this->never () )->method ( 'callback' );
	...
	public function testTriggerWithModParams() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->with ( array (
				'value' 
		) )->will ( $this->returnValue ( array (
				'new value' 
		) ) );
		
		$this->Objects->TriggerMockSecond->expects ( $this->once () )->method ( 'callback' )->with ( array (
				'new value' 
		) )->will ( $this->returnValue ( array (
				'newer value' 
		) ) );
		
		$result = $this->Objects->trigger ( 'callback', array (
				array (
						'value' 
				) 
		), array (
	...
	public function testTriggerModParamsInvalidIndex() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->never () )->method ( 'callback' );
		
		$this->Objects->TriggerMockSecond->expects ( $this->never () )->method ( 'callback' );
		
		$this->Objects->trigger ( 'callback', array (
				array (
						'value' 
				) 
		), array (
	...
	public function testTriggerPriority() {
		$this->_makeMockClasses ();
		$this->Objects->load ( 'TriggerMockFirst' );
		$this->Objects->load ( 'TriggerMockSecond', array (
				'priority' => 5 
		) );
		...
		$this->Objects->TriggerMockFirst->expects ( $this->any () )->method ( 'callback' )->will ( $this->returnValue ( '1st' ) );
		$this->Objects->TriggerMockSecond->expects ( $this->any () )->method ( 'callback' )->will ( $this->returnValue ( '2nd' ) );
		...
		$this->Objects->load ( 'TriggerMockThird', array (
				'priority' => 7 
		) );
		$this->mockObjects [] = $this->Objects->TriggerMockThird;
		$this->Objects->TriggerMockThird->expects ( $this->any () )->method ( 'callback' )->will ( $this->returnValue ( '3rd' ) );
	...
	public function testDispatchEventWithSubject() {
		...
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->with ( $subjectClass, 'first argument' )->will ( $this->returnValue ( true ) );
		$this->Objects->TriggerMockSecond->expects ( $this->once () )->method ( 'callback' )->with ( $subjectClass, 'first argument' )->will ( $this->returnValue ( true ) );
		
		$event = new CakeEvent ( 'callback', $subjectClass, array (
				'first argument' 
		) );
	...
	public function testDispatchEventNoSubject() {
		...
		$subjectClass = new Object ();
		$this->Objects->TriggerMockFirst->expects ( $this->once () )->method ( 'callback' )->with ( 'first argument' )->will ( $this->returnValue ( true ) );
		$this->Objects->TriggerMockSecond->expects ( $this->once () )->method ( 'callback' )->with ( 'first argument' )->will ( $this->returnValue ( true ) );
