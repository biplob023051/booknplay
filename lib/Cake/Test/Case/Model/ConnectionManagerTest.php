...
class ConnectionManagerTest extends CakeTestCase {
	 ...
	 *
	 * @return void @expectedException MissingDatasourceConfigException
	 */
	...
	public function testGetPluginDataSource() {
		...
		$name = 'test_source';
		$config = array (
				'datasource' => 'TestPlugin.TestSource' 
		);
	...
	public function testGetPluginDataSourceAndPluginDriver() {
		...
		$config = array (
				'datasource' => 'TestPlugin.Database/TestDriver' 
		);
	...
	public function testGetLocalDataSourceAndPluginDriver() {
		...
		$config = array (
				'datasource' => 'TestPlugin.Database/DboDummy' 
		);
	 ...
	 *
	 * @return void @expectedException MissingDatasourceException
	 */
	public function testLoadDataSourceException() {
		$connection = array (
				'classname' => 'NonExistentDataSource',
	...
	public function testConnectionData() {
		...
		ConnectionManager::create ( 'connection1', array (
				'datasource' => 'Test2Source' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection2', array (
				'datasource' => 'Test2Source' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection3', array (
				'datasource' => 'TestPlugin.TestSource' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection4', array (
				'datasource' => 'TestPlugin.TestSource' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection5', array (
				'datasource' => 'Test2OtherSource' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection6', array (
				'datasource' => 'Test2OtherSource' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection7', array (
				'datasource' => 'TestPlugin.TestOtherSource' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		...
		ConnectionManager::create ( 'connection8', array (
				'datasource' => 'TestPlugin.TestOtherSource' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
	...
	public function testDrop() {
		...
		ConnectionManager::create ( 'droppable', array (
				'datasource' => 'Test2Source' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
		$this->assertEquals ( array (
				'datasource' => 'Test2Source' 
		), $connections ['droppable'] );
