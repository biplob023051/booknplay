...
class BiddingMessage extends CakeTestModel {
	...
	public $belongsTo = array (
			'Bidding' => array (
					'foreignKey' => false,
					'conditions' => array (
							'BiddingMessage.bidding = Bidding.bid' 
					) 
			) 
	);
}
...
class Uuiditem extends CakeTestModel {
	...
	public $hasAndBelongsToMany = array (
			'Uuidportfolio' => array (
					'with' => 'UuiditemsUuidportfolioNumericid' 
			) 
	);
}
...
class TestModel4TestModel7 extends CakeTestModel {
	...
	public function schema($field = false) {
		if (! isset ( $this->_schema )) {
			$this->_schema = array (
					'test_model4_id' => array (
							'type' => 'integer',
							'null' => '',
							'default' => '',
							'length' => '8' 
					),
					'test_model7_id' => array (
							'type' => 'integer',
							'null' => '',
							'default' => '',
							'length' => '8' 
