...
class BasicsTest extends CakeTestCase {
	...
	public function testTranslate() {
		...
		$result = __ ( 'Some string with %s %s', array (
				'multiple',
				'arguments' 
		) );
		$expected = 'Some string with multiple arguments';
		...
		$result = __ ( 'Testing %2$s %1$s', array (
				'order',
				'different' 
		) );
		$expected = 'Testing different order';
	...
	public function testTranslatePlural() {
		...
		$result = __n ( '%d item for id %s', '%d items for id %s', 2, array (
				2,
				'1234' 
		) );
		$expected = '2 items for id 1234';
	...
	public function testTranslateDomain() {
		...
		$result = __d ( 'core', 'Some string with %s %s', array (
				'multiple',
				'arguments' 
		) );
		$expected = 'Some string with multiple arguments';
	...
	public function testTranslateDomainPlural() {
		...
		$result = __dn ( 'core', '%d item for id %s', '%d items for id %s', 2, array (
				2,
				'1234' 
		) );
		$expected = '2 items for id 1234';
	...
	public function testTranslateCategory() {
		...
		$result = __c ( 'Some string with %s %s', 6, array (
				'multiple',
				'arguments' 
		) );
		$expected = 'Some string with multiple arguments';
	...
	public function testTranslateDomainCategory() {
		...
		$result = __dc ( 'core', 'Some string with %s %s', 6, array (
				'multiple',
				'arguments' 
		) );
		$expected = 'Some string with multiple arguments';
	...
	public function testTranslateDomainCategoryPlural() {
		...
		$result = __dcn ( 'core', '%d item for id %s', '%d items for id %s', 2, 6, array (
				2,
				'1234' 
		) );
		$expected = '2 items for id 1234';
