...
class BakeShellTest extends CakeTestCase {
	...
	public function setUp() {
		...
		$this->Shell = $this->getMock ( 'BakeShell', array (
				'in',
				'out',
				'hr',
				'err',
	...
	public function testAllWithModelName() {
		...
		$this->Shell->Model = $this->getMock ( 'ModelTask', array (), array (
				&$this->Dispatcher 
		) );
		$this->Shell->Controller = $this->getMock ( 'ControllerTask', array (), array (
				&$this->Dispatcher 
		) );
		$this->Shell->View = $this->getMock ( 'ModelTask', array (), array (
				&$this->Dispatcher 
		) );
		$this->Shell->DbConfig = $this->getMock ( 'DbConfigTask', array (), array (
				&$this->Dispatcher 
		) );
