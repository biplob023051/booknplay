...
class ProjectTaskTest extends CakeTestCase {
	...
	public function setUp() {
		...
		$this->Task = $this->getMock ( 'ProjectTask', array (
				'in',
				'err',
				'createFile',
				'_stop' 
	...
	/**
	 * test bake with CakePHP on the include path.
	 * The constants should remain commented out.
	 *
	 * @return void
	 */
	...
	public function testCakeAdmin() {
		...
		$this->assertEquals ( Configure::read ( 'Routing.prefixes' ), array (
				'my_prefix' 
		) );
		$File->delete ();
	}
