...
class DbConfigTaskTest extends CakeTestCase {
	...
	public function setUp() {
		...
		$this->Task = $this->getMock ( 'DbConfigTask', array (
				'in',
				'out',
				'err',
				'hr',
	...
	public function testGetConfig() {
		$this->Task->expects ( $this->any () )->method ( 'in' )->will ( $this->returnValue ( 'test' ) );
	...
	public function testExecuteIntoInteractive() {
		...
		$this->Task->expects ( $this->at ( 15 ) )->method ( 'bake' )->with ( array (
				array (
						'name' => 'default',
						'datasource' => 'mysql',
						'persistent' => 'false',
