...
class ExtractTaskTest extends CakeTestCase {
	...
	public function setUp() {
		...
		$this->Task = $this->getMock ( 'ExtractTask', array (
				'in',
				'out',
				'err',
				'_stop' 
	...
	public function testExtractMultiplePaths() {
		...
		$this->Task->params ['paths'] = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Pages,' . CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Posts';
	...
	public function testExtractModelValidationWithDomainInModel() {
		App::build ( array (
				'Model' => array (
						CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'Model' . DS 
				) 
		) );
		$this->out = $this->getMock ( 'ConsoleOutput', array (), array (), '', false );
		$this->in = $this->getMock ( 'ConsoleInput', array (), array (), '', false );
