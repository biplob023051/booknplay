...
class ShellDispatcherTest extends CakeTestCase {
	...
	public function testDispatchShellWithMain() {
		...
		$Mock->expects ( $this->once () )->method ( 'runCommand' )->with ( null, array () )->will ( $this->returnValue ( true ) );
	...
	public function testDispatchShellWithoutMain() {
		...
		$Shell->expects ( $this->once () )->method ( 'runCommand' )->with ( 'initdb', array (
				'initdb' 
