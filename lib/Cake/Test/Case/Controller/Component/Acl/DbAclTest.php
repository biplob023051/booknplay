...
class DbAclTest extends CakeTestCase {
	...
	public function testAllow() {
		...
		$this->assertTrue ( $this->Acl->allow ( 'Micheal', 'tpsReports', array (
				'read',
				'delete',
				'update' 
		) ) );
	...
	public function testDeny() {
		...
		$result = $this->Acl->Aro->Permission->find ( 'all', array (
				'conditions' => array (
						'AroTwoTest.alias' => 'Samir' 
				) 
		) );
		$expected = '-1';
	...
	public function testGrant() {
		...
		$this->Acl->allow ( 'Micheal', 'view', array (
				'read',
				'create',
				'update' 
		) );
