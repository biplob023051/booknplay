...
class ComponentTest extends CakeTestCase {
	...
	public function testInnerComponentsAreNotEnabled() {
		...
		$this->assertEquals ( array (
				'Apple' 
		), $result, 'Too many components enabled.' );
	}
	...
	public function testSomethingReferencingEmailComponent() {
		...
		$Controller->Components->trigger ( 'initialize', array (
				&$Controller 
		) );
		$Controller->beforeFilter ();
		$Controller->Components->trigger ( 'startup', array (
				&$Controller 
		) );
