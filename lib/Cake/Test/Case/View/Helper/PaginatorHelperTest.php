...
class PaginatorHelperTest extends CakeTestCase {
	...
	public function setUp() {
		...
		$this->Paginator->Js = $this->getMock ( 'PaginatorHelper', array (), array (
				$this->View 
		) );
	...
	public function testSortLinks() {
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/param/page:1/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/param/page:1/sort:date/direction:desc',
						'class' => 'asc' 
				),
				'Date',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/param/page:1/sort:title/direction:desc',
						'class' => 'asc' 
				),
				'descending',
				'/a' 
		...
		$this->Paginator->request->params ['paging'] ['Article'] ['options'] ['order'] = array (
				'Article.title' => 'desc' 
		);
	...
	public function testSortLinkWithVirtualField() {
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/page:1/sort:Article.full_name/direction:desc',
						'class' => 'asc' 
				),
				'Article Full Name',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/page:1/sort:full_name/direction:desc',
						'class' => 'asc' 
				),
				'Full Name',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/page:1/sort:Article.full_name/direction:asc',
						'class' => 'desc' 
				),
				'Article Full Name',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/page:1/sort:full_name/direction:asc',
						'class' => 'desc' 
				),
				'Full Name',
				'/a' 
	...
	public function testSortLinksUsingDirectionOption() {
		...
		$result = $this->Paginator->sort ( 'title', 'TestTitle', array (
				'direction' => 'desc' 
		) );
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/param/page:1/sort:title/direction:desc' 
				),
				'TestTitle',
				'/a' 
		);
	...
	public function testSortLinksUsingDotNotation() {
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/page:1/sort:Article.title/direction:asc',
						'class' => 'desc' 
				),
				'Article Title',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/page:1/sort:Article.title/direction:desc',
						'class' => 'asc' 
				),
				'Title',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/page:1/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
	...
	public function testSortKey() {
		...
		$result = $this->Paginator->sortKey ( 'Article', array (
				'order' => 'Article.title' 
		) );
		$this->assertEquals ( 'Article.title', $result );
	...
	public function testSortDir() {
		...
		unset ( $this->Paginator->request->params ['paging'] ['Article'] ['options'] );
		$result = $this->Paginator->sortDir ( 'Article', array (
				'direction' => 'asc' 
		) );
		$expected = 'asc';
	...
	public function testSortAdminLinks() {
		...
		$expected = array (
				'a' => array (
						'href' => '/admin/test/index/param/page:1/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/admin/test/index/param/page:1/sort:Article.title/direction:asc' 
				),
				'Title',
				'/a' 
		);
	...
	public function testUrlGeneration() {
		...
		$expected = array (
				'a' => array (
						'href' => '/index/page:1/sort:controller/direction:asc' 
				),
				'Controller',
				'/a' 
		);
	...
	public function testUrlGenerationWithPrefixes() {
		...
		$result = $this->Paginator->sort ( 'name', null, array (
				'url' => $options 
		) );
		$expected = array (
				'a' => array (
						'href' => '/members/posts/index/page:2/sort:name/direction:asc' 
				),
				'Name',
				'/a' 
		);
		...
		$result = $this->Paginator->next ( 'next', array (
				'url' => $options 
		) );
		$expected = array (
				'span' => array (
				...
				'a' => array (
						'href' => '/members/posts/index/page:3',
						'rel' => 'next' 
				),
				'next',
				'/a',
		...
		$expected = array (
				...
				'a' => array (
						'href' => '/members/posts/index/page:1',
						'rel' => 'prev' 
				),
				'prev',
				'/a',
	...
	public function testPassedArgsMergingWithUrlOptions() {
		...
		$this->Paginator->request->params ['pass'] = array (
				2 
		);
		$this->Paginator->request->params ['named'] = array (
				'foo' => 'bar' 
		);
		$this->Paginator->request->query = array (
				'x' => 'y' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/articles/index/2/page:1/foo:bar/sort:title/direction:asc?x=y' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:2/foo:bar?x=y' 
						) 
				),
				'2',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:3/foo:bar?x=y' 
						) 
				),
				'3',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:4/foo:bar?x=y' 
						) 
				),
				'4',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:5/foo:bar?x=y' 
						) 
				),
				'5',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:6/foo:bar?x=y' 
						) 
				),
				'6',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:7/foo:bar?x=y' 
						) 
				),
				'7',
				'/a',
	...
	public function testPassedArgsMergingWithUrlOptionsParamTypeQuerystring() {
		...
		$expected = array (
				'a' => array (
						'href' => '/articles/index/2/foo:bar?x=y&amp;page=1&amp;sort=title&amp;direction=asc' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/foo:bar?x=y&amp;page=2' 
						) 
				),
				'2',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/foo:bar?x=y&amp;page=3' 
						) 
				),
				'3',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/foo:bar?x=y&amp;page=4' 
						) 
				),
				'4',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/foo:bar?x=y&amp;page=5' 
						) 
				),
				'5',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/foo:bar?x=y&amp;page=6' 
						) 
				),
				'6',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/foo:bar?x=y&amp;page=7' 
						) 
				),
				'7',
				'/a',
	...
	public function testPagingLinks() {
		...
		$result = $this->Paginator->prev ( '<< Previous', null, null, array (
				'class' => 'disabled' 
		) );
		$expected = array (
				'span' => array (
		...
		$result = $this->Paginator->prev ( '<< Previous', array (
				'tag' => false 
		), null, array (
				'class' => 'disabled' 
		) );
		...
		$result = $this->Paginator->prev ( '<< Previous', array (), null, array (
				'disabledTag' => 'span',
				'class' => 'disabled' 
		) );
		$expected = array (
		...
		$result = $this->Paginator->prev ( '<< Previous', null, '<strong>Disabled</strong>', array (
				'escape' => true 
		) );
		$expected = array (
				'span' => array (
		...
		$result = $this->Paginator->next ( 'Next', array (), null, array (
				'tag' => false 
		) );
		$expected = array (
				'span' => array (
		...
		$expected = array (
				...
				'a' => array (
						'href' => '/index/12/page:1/limit:10/foo:bar',
						'rel' => 'prev' 
				),
				'Prev',
				'/a',
	...
	public function testGenericLinks() {
		...
		$expected = array (
				'a' => array (
						'href' => '/index/page:5/sort:title/direction:desc' 
				),
		...
		$expected = array (
				'a' => array (
						'href' => '/index/page:2/sort:title/direction:desc' 
				),
				'Sort by title',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/index/page:4/sort:Article.title/direction:desc' 
				),
	...
	public function testGenericLinksWithPresetOptions() {
		$result = $this->Paginator->link ( 'Foo!', array (
				'page' => 1 
		) );
		...
		$this->assertTags ( $result, array (
				'a' => array (
						'href' => '/index/page:1/sort:title/direction:desc' 
				),
				'Foo!',
				'/a' 
		) );
	...
	public function testNumbers() {
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => '/index/page:1/sort:Client.name/direction:DESC' 
						) 
				),
				'1',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/index/page:3/sort:Client.name/direction:DESC' 
						) 
				),
				'3',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/index/page:4/sort:Client.name/direction:DESC' 
						) 
				),
				'4',
				'/a',
	...
	public function testFirstAndLastTag() {
		$result = $this->Paginator->first ( '<<', array (
				'tag' => 'li',
				'class' => 'first' 
		) );
		$expected = array (
		...
		$result = $this->Paginator->last ( 2, array (
				'tag' => 'li',
				'class' => 'last' 
		) );
		$expected = array (
	...
	public function testFirstFullBaseUrl() {
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => FULL_BASE_URL . '/index/page:1/sort:Article.title/direction:DESC',
								'rel' => 'first' 
						) 
				),
				'&lt;&lt; first',
	...
	public function testLastOptions() {
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => '/index/page:14/sort:Client.name/direction:DESC' 
						) 
				),
				'14',
				'/a',
	...
	public function testCounter() {
		...
		$result = $this->Paginator->counter ( array (
				'format' => $input 
		) );
		$expected = 'Page 1 of 5';
		$this->assertEquals ( $expected, $result );
	...
	public function testWithPlugin() {
		...
		Router::setRequestInfo ( array (
				array (
						...
						'url' => array (
								'ext' => 'html',
								'url' => 'my_plugin/magazines' 
						) 
				),
				array (
						'base' => '',
						'here' => '/my_plugin/magazines',
						'webroot' => '/' 
				) 
		) );
		
		$result = $this->Paginator->link ( 'Page 3', array (
				'page' => 3 
		) );
		$expected = array (
				'a' => array (
						'href' => '/my_plugin/magazines/index/page:3' 
				),
				'Page 3',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/my_plugin/magazines/another_index/page:3' 
				),
				'Page 3',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/my_plugin/issues/index/page:3' 
				),
				'Page 3',
				'/a' 
		);
	...
	public function testAjaxLinkGenerationLink() {
		$this->Paginator->Js->expects ( $this->once () )->method ( 'link' )->will ( $this->returnValue ( 'I am a link' ) );
		
		$result = $this->Paginator->link ( 'test', array (
				'controller' => 'posts' 
		), array (
				'update' => '#content' 
		) );
	...
	public function testMockAjaxProviderClassInjection() {
		$mock = $this->getMock ( 'PaginatorHelper', array (), array (
				$this->View 
		), 'PaginatorMockJsHelper' );
		$Paginator = new PaginatorHelper ( $this->View, array (
				'ajax' => 'PaginatorMockJs' 
		) );
		...
		$Paginator->link ( 'Page 2', array (
				'page' => 2 
		), array (
				'update' => '#content' 
		) );
		
		new PaginatorHelper ( $this->View, array (
				'ajax' => 'Form' 
		) );
	}
