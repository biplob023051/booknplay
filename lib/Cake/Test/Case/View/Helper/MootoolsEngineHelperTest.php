...
class MootoolsEngineHelperTest extends CakeTestCase {
	...
	public function testEvent() {
		$this->Moo->get ( '#myLink' );
		$result = $this->Moo->event ( 'click', 'doClick', array (
				'wrap' => false 
		) );
		$expected = '$("myLink").addEvent("click", doClick);';
		$this->assertEquals ( $expected, $result );
		
		$result = $this->Moo->event ( 'click', 'this.setStyle("display", "");', array (
				'stop' => false 
		) );
	...
	public function testEffect() {
		...
		$result = $this->Moo->effect ( 'slideOut', array (
				'speed' => 'fast' 
		) );
	...
	public function testRequest() {
		...
		$result = $this->Moo->request ( '/posts/view/1', array (
				'update' => 'content' 
		) );
	...
	public function testSerializeForm() {
		...
		$result = $this->Moo->serializeForm ( array (
				'isForm' => true 
		) );
