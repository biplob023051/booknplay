...
class Contact extends CakeTestModel {
	...
	public $validate = array (
			...
			'imrequiredonupdate' => array (
					'notEmpty' => array (
							'rule' => 'alphaNumeric',
							'on' => 'update' 
					) 
			),
			'imrequiredoncreate' => array (
					'required' => array (
							'rule' => 'alphaNumeric',
							'on' => 'create' 
					) 
...
class FormHelperTest extends CakeTestCase {
	...
	public function testNoCheckboxLocking() {
		...
		$this->Form->checkbox ( 'check', array (
				'value' => '1' 
		) );
	...
	public function testTextFieldGenerationForFloats() {
		...
		$result = $this->Form->input ( 'foo', array (
				'step' => 0.5 
		) );
		$expected = array (
				'div' => array (
	...
	public function testFormSecurityMultipleSubmitButtons() {
		...
		$result = $this->Form->submit ( 'Save', array (
				'name' => 'save' 
		) );
		$expected = array (
				'div' => array (
		...
		$this->assertTags ( $result, $expected );
		$result = $this->Form->submit ( 'Cancel', array (
				'name' => 'cancel' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testSecuritySubmitImageName() {
		...
		$this->Form->create ( 'User' );
		$result = $this->Form->submit ( 'save.png', array (
				'name' => 'test' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testFormSecurityMultipleInputFields() {
		...
		$this->Form->hidden ( 'Addresses.0.id', array (
				'value' => '123456' 
		) );
		...
		$this->Form->input ( 'Addresses.0.primary', array (
				'type' => 'checkbox' 
		) );
		
		$this->Form->hidden ( 'Addresses.1.id', array (
				'value' => '654321' 
		) );
		...
		$this->Form->input ( 'Addresses.1.primary', array (
				'type' => 'checkbox' 
		) );
	...
	public function testFormSecurityInputUnlockedFields() {
		...
		$this->Form->hidden ( 'Addresses.id', array (
				'value' => '123456' 
		) );
	...
	public function testFormSecureWithCustomNameAttribute() {
		...
		$this->Form->text ( 'UserForm.published', array (
				'name' => 'data[User][custom]' 
		) );
		$this->assertEquals ( 'User.custom', $this->Form->fields [0] );
		
		$this->Form->text ( 'UserForm.published', array (
				'name' => 'data[User][custom][another][value]' 
		) );
	...
	public function testFormSecuredInput() {
		...
		$result = $this->Form->input ( 'UserForm.published', array (
				'type' => 'text' 
		) );
		$expected = array (
				'div' => array (
		...
		$result = $this->Form->input ( 'UserForm.other', array (
				'type' => 'text' 
		) );
		$expected = array (
				'div' => array (
		...
		$result = $this->Form->hidden ( 'UserForm.hidden', array (
				'value' => '0' 
		) );
		$expected = array (
				'input' => array (
	...
	public function testFormSecuredMultipleSelect() {
		...
		$this->Form->fields = array ();
		$this->Form->select ( 'Model.select', $options, array (
				'multiple' => true 
		) );
		$this->assertEquals ( $expected, $this->Form->fields );
	}
	...
	public function testFormSecuredAndDisabledNotAssoc() {
		...
		$this->Form->select ( 'Model.select', array (
				1,
				2 
		), array (
				'disabled' 
		) );
		$this->Form->checkbox ( 'Model.checkbox', array (
				'disabled' 
		) );
		$this->Form->text ( 'Model.text', array (
				'disabled' 
		) );
		$this->Form->textarea ( 'Model.textarea', array (
				'disabled' 
		) );
		$this->Form->password ( 'Model.password', array (
				'disabled' 
		) );
		$this->Form->radio ( 'Model.radio', array (
				1,
				2 
		), array (
				'disabled' 
	...
	public function testFormSecuredAndDisabled() {
		...
		$this->Form->password ( 'Model.text', array (
				'disabled' => true 
		) );
		$this->Form->textarea ( 'Model.textarea', array (
				'disabled' => true 
		...
		$this->Form->year ( 'Model.year', null, null, array (
				'disabled' => true 
		) );
		$this->Form->month ( 'Model.month', array (
				'disabled' => true 
		) );
		$this->Form->day ( 'Model.day', array (
				'disabled' => true 
		) );
		$this->Form->hour ( 'Model.hour', false, array (
				'disabled' => true 
		) );
		$this->Form->minute ( 'Model.minute', array (
				'disabled' => true 
		) );
		$this->Form->meridian ( 'Model.meridian', array (
				'disabled' => true 
		) );
	...
	public function testDisableSecurityUsingForm() {
		...
		$this->Form->input ( 'Addresses.title' );
		$this->Form->input ( 'Addresses.first_name', array (
				'secure' => false 
		) );
		$this->Form->input ( 'Addresses.city', array (
				'type' => 'textarea',
				'secure' => false 
		) );
	...
	public function testUnlockFieldRemovingFromFields() {
		...
		$this->Form->create ( 'Contact' );
		$this->Form->hidden ( 'Contact.id', array (
				'value' => 1 
		) );
		$this->Form->text ( 'Contact.name' );
	...
	public function testTagIsInvalid() {
		...
		$Contact->validationErrors [0] ['email'] = $expected = array (
	...
	public function testPasswordValidation() {
		$Contact = ClassRegistry::getObject ( 'Contact' );
		$Contact->validationErrors ['password'] = array (
	...
	public function testFormValidationAssociated() {
		...
		$result = $this->Form->error ( 'OpenidUrl.openid_not_registered', 'Error, not registered', array (
				'wrap' => false 
		) );
	...
	public function testFormValidationAssociatedFirstLevel() {
		...
		$result = $this->Form->create ( 'ValidateUser', array (
				'type' => 'post',
				'action' => 'add' 
		) );
		$encoding = strtolower ( Configure::read ( 'App.encoding' ) );
		...
		$result = $this->Form->error ( 'ValidateUser.email', 'Invalid email', array (
				'wrap' => false 
		) );
		$this->assertEquals ( 'Invalid email', $result );
		
		$result = $this->Form->error ( 'ValidateProfile.full_name', 'Invalid name', array (
				'wrap' => false 
		) );
		$this->assertEquals ( 'Invalid name', $result );
		
		$result = $this->Form->error ( 'ValidateProfile.city', 'Invalid city', array (
				'wrap' => false 
		) );
	...
	public function testFormValidationAssociatedSecondLevel() {
		...
		$result = $this->Form->error ( 'ValidateItem.description', 'Invalid description', array (
				'wrap' => false 
		) );
	...
	public function testInput() {
		...
		$result = $this->Form->input ( 'Contact.5.email', array (
				'type' => 'text' 
		) );
		$expected = array (
				'div' => array (
		...
		$result = $this->Form->input ( 'Model.0.OtherModel.field', array (
				'id' => 'myId' 
		) );
		$expected = array (
				'div' => array (
		...
		$Contact = ClassRegistry::getObject ( 'Contact' );
		$Contact->validationErrors ['field'] = array (
				'Badness!' 
		);
		...
		$result = $this->Form->input ( 'Object.field', array (
				'after' => 'A message to you, Rudy' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testInputCheckbox() {
		$result = $this->Form->input ( 'User.active', array (
				'label' => false,
				'checked' => true 
		) );
		$expected = array (
	...
	public function testInputDatetime() {
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ContactCreatedMonth' 
				),
				'Created',
				'/label',
				array (
						'select' => array (
								'name' => 'data[Contact][created][month]',
								'id' => 'ContactCreatedMonth' 
						) 
				),
				array (
						'option' => array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][created][day]',
								'id' => 'ContactCreatedDay' 
						) 
				),
				array (
						'option' => array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][created][year]',
								'id' => 'ContactCreatedYear' 
						) 
				),
				array (
						'option' => array (
	...
	public function testInputCheckboxesInLoop() {
		for($i = 1; $i < 5; $i ++) {
			$result = $this->Form->input ( "Contact.{$i}.email", array (
					'type' => 'checkbox',
					'value' => $i 
			) );
			$expected = array (
	...
	public function testInputSelectType() {
		...
		$this->View->viewVars ['users'] = array (
				'value' => 'good',
				'other' => 'bad' 
		);
		$this->Form->request->data = array (
		...
		$result = $this->Form->input ( 'Model.user_id', array (
				'empty' => true 
		) );
		$expected = array (
				'div' => array (
		...
		$result = $this->Form->input ( 'User.User', array (
				'empty' => true 
		) );
		$expected = array (
				'div' => array (
	...
	public function testInputOverridingMagicSelectType() {
		...
		$this->View->viewVars ['types'] = array (
				'value' => 'good',
				'other' => 'bad' 
		);
	...
	public function testInputMagicSelectForTypeNumber() {
		$this->View->viewVars ['balances'] = array (
				0 => 'nothing',
				1 => 'some',
				100 => 'a lot' 
		);
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ValidateUserBalance' 
				),
				'Balance',
				'/label',
				'select' => array (
						'name' => 'data[ValidateUser][balance]',
						'id' => 'ValidateUserBalance' 
				),
				array (
						'option' => array (
								'value' => '0' 
	...
	public function testInputWithMatchingFieldAndModelName() {
		...
		$result = $this->Form->input ( 'User', array (
				'type' => 'text' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testFormInputs() {
		...
		$result = $this->Form->inputs ( 'Field of Dreams', null, array (
				'fieldset' => 'classy-stuff' 
		) );
		$this->assertTags ( $result, $expected );
	...
	public function testTextbox() {
		...
		$result = $this->Form->text ( 'Model.field', array (
				'type' => 'password' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
		...
		$Contact = ClassRegistry::getObject ( 'Contact' );
		$Contact->validationErrors ['text'] = array (
				true 
		);
		$this->Form->request->data ['Contact'] ['text'] = 'test';
		$result = $this->Form->text ( 'Contact.text', array (
				'id' => 'theID' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
		...
		$this->Form->request->data ['Model'] ['0'] ['OtherModel'] ['field'] = 'My value';
		$result = $this->Form->text ( 'Model.0.OtherModel.field', array (
				'id' => 'myId' 
		) );
		$expected = array (
				'input' => array (
	...
	public function testError() {
		...
		$result = $this->Form->error ( 'Contact.field', 'There is an error fool!', array (
				'wrap' => 'span' 
		) );
		$this->assertTags ( $result, array (
				'span' => array (
	...
	public function testInputErrorEscape() {
		...
		$ValidateProfile->validationErrors ['city'] = array (
				'required<br>' 
		);
	...
	public function testPassword() {
		...
		$result = $this->Form->password ( 'Contact.passwd', array (
				'id' => 'theID' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
	...
	public function testRadio() {
		...
		$result = $this->Form->radio ( 'Employee.gender', array (
				'male' => 'Male',
				'female' => 'Female' 
		) );
		$expected = array (
		...
		$result = $this->Form->radio ( 'Officer.gender', array (
				'male' => 'Male',
				'female' => 'Female' 
		) );
		$expected = array (
		...
		$result = $this->Form->radio ( 'Contact.1.imrequired', array (
				'option A' 
		) );
		$expected = array (
				'input' => array (
		...
		$result = $this->Form->radio ( 'Model.1.field', array (
				'option A' 
		) );
		$expected = array (
				'input' => array (
	...
	/**
	 * Test radio inputs with between as string or array.
	 * Also ensure
	...
	public function testSelect() {
		...
		$result = $this->Form->select ( 'Model.field', $options, array (
				'escape' => false,
				'empty' => false 
		) );
		$expected = array (
		...
		$result = $this->Form->select ( 'Model.contact_id', array (
				'228' => '228 value',
				'228-1' => '228-1 value',
				'228-2' => '228-2 value' 
		), array (
	...
	public function testSelectMultiple() {
		...
		$result = $this->Form->select ( 'Model.multi_field', $options, array (
				'multiple' => true 
		) );
		$expected = array (
				'input' => array (
	...
	public function testHabtmSelectBox() {
		...
		$this->Form->create ( 'Contact' );
		$result = $this->Form->input ( 'ContactTag', array (
				'div' => false,
				'label' => false 
		) );
		$expected = array (
	...
	public function testSelectMultipleSecureWithNoOptions() {
		...
		$this->Form->select ( 'Model.select', array (), array (
				'multiple' => true 
		) );
		$this->assertEquals ( array (
				'Model.select' 
	...
	public function testCheckbox() {
		...
		$result = $this->Form->checkbox ( 'Contact.published', array (
				'id' => 'theID' 
		) );
		$expected = array (
				'input' => array (
	...
	public function testCheckboxCustomNameAttribute() {
		$result = $this->Form->checkbox ( 'Test.test', array (
				'name' => 'myField' 
		) );
		$expected = array (
				'input' => array (
	...
	public function testCheckboxDisabling() {
		$result = $this->Form->checkbox ( 'Account.show_name', array (
				'disabled' => 'disabled' 
		) );
		$expected = array (
				array (
	...
	public function testDateTime() {
		...
		$expected = array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][date][meridian]',
		...
		$result = $this->Form->dateTime ( 'Model.field', 'DMY', '12', array (
				'empty' => false 
		) );
		$expected = array (
				array (
						'select' => array (
								'name' => 'data[Model][field][day]',
								'id' => 'ModelFieldDay' 
						) 
				),
				$daysRegex,
				...
				array (
						'select' => array (
								'name' => 'data[Model][field][meridian]',
								'id' => 'ModelFieldMeridian' 
						) 
				),
				$meridianRegex,
				array (
		...
		$result = $this->Form->input ( 'published2', array (
				'type' => 'date' 
		) );
		$now = strtotime ( 'now' );
		$expected = array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][published2][day]',
								'id' => 'ContactPublished2Day' 
						) 
				),
				$daysRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][published2][year]',
								'id' => 'ContactPublished2Year' 
						) 
				),
				$yearsRegex,
				array (
	...
	public function testFormDateTimeMulti() {
		...
		$expected = array (
				array (
						'select' => array (
								'name' => 'data[Contact][1][updated][day]',
								'id' => 'Contact1UpdatedDay' 
						) 
				),
				$daysRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][1][updated][month]',
								'id' => 'Contact1UpdatedMonth' 
						) 
				),
				$monthsRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][1][updated][year]',
								'id' => 'Contact1UpdatedYear' 
						) 
				),
				$yearsRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][1][updated][hour]',
								'id' => 'Contact1UpdatedHour' 
						) 
				),
				$hoursRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][1][updated][min]',
								'id' => 'Contact1UpdatedMin' 
						) 
				),
				$minutesRegex,
				array (
		...
		$expected = array (
				array (
						'select' => array (
								'name' => 'data[Contact][2][updated][day]',
								'id' => 'Contact2UpdatedDay' 
						) 
				),
				$daysRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][2][updated][month]',
								'id' => 'Contact2UpdatedMonth' 
						) 
				),
				$monthsRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][2][updated][year]',
								'id' => 'Contact2UpdatedYear' 
						) 
				),
				$yearsRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][2][updated][hour]',
								'id' => 'Contact2UpdatedHour' 
						) 
				),
				$hoursRegex,
				array (
				...
				array (
						'select' => array (
								'name' => 'data[Contact][2][updated][min]',
								'id' => 'Contact2UpdatedMin' 
						) 
				),
				$minutesRegex,
				array (
	...
	public function testDateTimeLabelIdMatchesFirstInput() {
		$result = $this->Form->input ( 'Model.date', array (
				'type' => 'date' 
		) );
	...
	public function testMonth() {
		...
		$result = $this->Form->month ( 'Model.field', array (
				'empty' => true 
		) );
		$expected = array (
				array (
		...
		$expected = array (
				array (
						'select' => array (
								'name' => 'data[Project][release][month]',
								'id' => 'ProjectReleaseMonth' 
						) 
				),
				array (
						'option' => array (
	...
	public function testDay() {
		...
		$result = $this->Form->day ( 'Model.field', array (
				'value' => false 
		) );
		$expected = array (
				array (
		...
		$expected = array (
				array (
						'select' => array (
								'name' => 'data[Project][release][day]',
								'id' => 'ProjectReleaseDay' 
						) 
				),
				array (
						'option' => array (
	...
	public function testMinute() {
		...
		$this->Form->request->data ['Model'] ['field'] = '';
		$result = $this->Form->minute ( 'Model.field', array (
				'interval' => 5 
		) );
		$expected = array (
				array (
	...
	public function testHour() {
		...
		$this->Form->request->data ['Model'] ['field'] = '';
		$result = $this->Form->hour ( 'Model.field', true, array (
				'value' => '23' 
		) );
		$this->assertContains ( '<option value="23" selected="selected">23</option>', $result );
		
		$result = $this->Form->hour ( 'Model.field', false, array (
				'value' => '23' 
		) );
	...
	public function testYear() {
		...
		$result = $this->Form->year ( 'Model.field', 2006, 2007, array (
				'orderYear' => 'asc' 
		) );
		$expected = array (
				array (
		...
		$this->Form->request->data = array ();
		$this->Form->create ( 'Contact' );
		$result = $this->Form->year ( 'published', 2006, 2008, array (
				'empty' => false 
		) );
		$expected = array (
				array (
		...
		$result = $this->Form->year ( 'published', array (), array (), array (
				'empty' => false 
		) );
	...
	public function testInputDate() {
		...
		$result = $this->Form->input ( 'just_year', array (
				'type' => 'date',
				'label' => false,
				'dateFormat' => 'Y',
				'minYear' => date ( 'Y' ),
		...
		$result = $this->Form->input ( 'just_month', array (
				'type' => 'date',
				'label' => false,
				'dateFormat' => 'M',
				'empty' => false 
		...
		$result = $this->Form->input ( 'just_day', array (
				'type' => 'date',
				'label' => false,
				'dateFormat' => 'D',
				'empty' => false 
	...
	public function testTextArea() {
		...
		$this->Form->request->data = array (
				'Model' => array (
						'field' => 'some <strong>test</strong> data with <a href="#">HTML</a> chars' 
				) 
		);
		$result = $this->Form->textarea ( 'Model.field' );
		$expected = array (
		...
		$result = $this->Form->textarea ( 'Model.field', array (
				'escape' => false 
		) );
		$expected = array (
				'textarea' => array (
	...
	public function testHiddenField() {
		...
		$result = $this->Form->hidden ( 'Contact.field', array (
				'id' => 'theID' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
	...
	public function testFileUploadField() {
		...
		$result = $this->Form->input ( 'Model.upload', array (
				'type' => 'file' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testFileUploadOnOtherModel() {
		$this->Form->create ( 'ValidateUser', array (
				'type' => 'file' 
		) );
		...
		$expected = array (
				'input' => array (
						'type' => 'file',
						'name' => 'data[ValidateProfile][city]',
						'id' => 'ValidateProfileCity' 
				) 
		);
		$this->assertTags ( $result, $expected );
	}
	...
	public function testButton() {
		...
		$result = $this->Form->button ( 'No type', array (
				'type' => false 
		) );
		$this->assertTags ( $result, array (
				'button' => array (),
	...
	public function testPostButton() {
		...
		$result = $this->Form->postButton ( 'Send', '/', array (
				'data' => array (
						'extra' => 'value' 
				) 
		) );
	...
	public function testPostLink() {
		...
		$result = $this->Form->postLink ( 'Delete', '/posts/delete', array (
				'data' => array (
						'id' => 1 
				) 
		) );
	...
	public function testSubmitButton() {
		...
		$result = $this->Form->submit ( 'Test Submit', array (
				'div' => array (
						'tag' => 'span' 
				) 
		) );
		...
		$result = $this->Form->submit ( 'Next >', array (
				'escape' => false 
		) );
		$expected = array (
				'div' => array (
		...
		$result = $this->Form->submit ( 'Reset!', array (
				'type' => 'reset' 
		) );
		$expected = array (
				'div' => array (
		...
		$before = '--before--';
		$after = '--after--';
		$result = $this->Form->submit ( 'Test', array (
				'before' => $before 
		) );
		$expected = array (
				'div' => array (
	...
	public function testSubmitImage() {
		...
		$expected = array (
				...
				'input' => array (
						'type' => 'image',
						'src' => 'http://example.com/cake.power.gif' 
				),
				'/div' 
		);
		$this->assertTags ( $result, $expected );
		...
		$after = '--after--';
		$before = '--before--';
		$result = $this->Form->submit ( 'cake.power.gif', array (
				'after' => $after 
		) );
		$expected = array (
				'div' => array (
		...
		$result = $this->Form->submit ( 'Not.an.image', array (
				'before' => $before,
				'after' => $after 
		) );
		$expected = array (
	...
	public function testSubmitUnlockedByDefault() {
		...
		$this->assertEquals ( array (
				'save' 
		), $result, 'Only submits with name attributes should be unlocked.' );
	}
	...
	public function testCreate() {
		...
		$result = $this->Form->create ( 'ContactNonStandardPk', array (
				'url' => array (
						'action' => 'edit' 
				) 
		) );
		...
		$this->Form->request ['action'] = 'add';
		$result = $this->Form->create ( 'User', array (
				'url' => array (
						'action' => 'login' 
				) 
		) );
	...
	public function testCreateWithMultipleIdInData() {
		...
		$this->Form->request->data ['Contact'] ['id'] = array (
				1,
				2 
		);
		$result = $this->Form->create ( 'Contact' );
	...
	public function testEditFormWithData() {
		...
		$this->Form->create ();
		$result = $this->Form->select ( 'People.People', $options, array (
				'multiple' => true 
		) );
		$expected = array (
				'input' => array (
	...
	public function testFormInputRequiredDetection() {
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ContactImnotrequiredeither' 
				),
				'Imnotrequiredeither',
				'/label',
				'input' => array (
		...
		$result = $this->Form->input ( 'Contact.boolean_field', array (
				'type' => 'checkbox' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testFormMagicInput() {
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ContactNonExistingFieldInContactModel' 
				),
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'AddressNonExistingFieldInModel' 
				),
		...
		$result = $this->Form->input ( 'Contact.updated', array (
				'div' => false 
		) );
		$expected = array (
				'label' => array (
						'for' => 'ContactUpdatedMonth' 
				),
				'Updated',
				'/label',
				array (
	...
	public function testForMagicInputNonExistingNorValidated() {
		...
		$expected = array (
				'label' => array (
						'for' => 'ContactNonExistingNorValidated' 
				),
	...
	public function testMultiRecordForm() {
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ValidateProfile1ValidateItem2Name' 
				),
				'Name',
				'/label',
				'textarea' => array (
		...
		$result = $this->Form->input ( 'ValidateProfile.1.ValidateItem.2.created', array (
				'empty' => true 
		) );
		$expected = array (
				'div' => array (
				...
				'label' => array (
						'for' => 'ValidateProfile1ValidateItem2CreatedMonth' 
				),
				'Created',
				'/label',
				array (
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ValidateProfile1ValidateItem2ProfileId' 
				),
				'Profile',
				'/label',
				'select' => array (
	...
	public function testMultiRecordFormValidationErrors() {
		$this->Form->create ( 'ValidateProfile' );
		$ValidateProfile = ClassRegistry::getObject ( 'ValidateProfile' );
		$ValidateProfile->validationErrors [2] ['ValidateItem'] [1] ['name'] = array (
				'Error in field name' 
		);
		...
		$ValidateProfile->validationErrors [2] ['city'] = array (
				'Error in field city' 
		);
	...
	public function testSaveManyRecordFormValidationErrors() {
		...
		$ValidateUser->validationErrors [0] ['ValidateItem'] ['name'] = array (
				'Error in field name' 
		);
		...
		$ValidateUser->validationErrors [0] ['city'] = array (
				'Error in field city' 
		);
	...
	public function testHtml5Inputs() {
		...
		$result = $this->Form->search ( 'User.query', array (
				'value' => 'test' 
		) );
		$expected = array (
				'input' => array (
	...
	public function testCustomValidationErrors() {
		...
		$result = $this->Form->error ( 'Thing.field', null, array (
				'wrap' => false 
		) );
	...
	public function testRequiredOnCreate() {
		...
		$result = $this->Form->input ( 'Contact.imrequired', array (
				'required' => false 
		) );
		$this->assertTags ( $result, $expected );
