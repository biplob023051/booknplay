...
class JqueryEngineHelperTest extends CakeTestCase {
	...
	public function testEvent() {
		...
		$result = $this->Jquery->event ( 'click', 'doClick', array (
				'wrap' => false 
		) );
		$expected = '$("#myLink").bind("click", doClick);';
		$this->assertEquals ( $expected, $result );
		
		$result = $this->Jquery->event ( 'click', '$(this).show();', array (
				'stop' => false 
		) );
	...
	public function testEffect() {
		...
		$result = $this->Jquery->effect ( 'hide', array (
				'speed' => 'fast' 
		) );
	...
	public function testRequest() {
		$result = $this->Jquery->request ( array (
				'controller' => 'posts',
				'action' => 'view',
				1 
		) );
	...
	public function testSerializeForm() {
		$this->Jquery->get ( '#element' );
		$result = $this->Jquery->serializeForm ( array (
				'isForm' => false 
		) );
