...
class CakeTestCaseTest extends CakeTestCase {
	...
	public function testGetMockForModel() {
		...
		$Post = $this->getMockForModel ( 'Post', array (
				'save' 
		) );
	...
	public function testGetMockForModelWithPlugin() {
		...
		$TestPluginComment = $this->getMockForModel ( 'TestPlugin.TestPluginComment', array (
				'save' 
		) );
		
		$this->assertInstanceOf ( 'TestPluginComment', $TestPluginComment );
		$TestPluginComment->expects ( $this->at ( 0 ) )->method ( 'save' )->will ( $this->returnValue ( true ) );
		$TestPluginComment->expects ( $this->at ( 1 ) )->method ( 'save' )->will ( $this->returnValue ( false ) );
