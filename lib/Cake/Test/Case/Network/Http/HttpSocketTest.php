...
class HttpSocketTest extends CakeTestCase {
	...
	public function testConfigUri() {
		...
		$this->assertTrue ( $r );
		$r = $this->Socket->configUri ( array (
				'host' => 'www.foo-bar.org' 
		) );
	...
	public function testRequest2() {
		...
		$this->Socket->expects ( $this->once () )->method ( 'write' )->with ( "GET / HTTP/1.1\r\nHost: www.cakephp.org\r\nConnection: close\r\nUser-Agent: CakePHP\r\n\r\n" );
	...
	public function testRequestWithConstructor() {
		...
		$expected = array (
				'method' => 'GET',
				'uri' => 'http://localhost:5984/_test?count=4' 
		);
		$http->expects ( $this->at ( 0 ) )->method ( 'request' )->with ( $expected );
		$http->get ( '/_test', array (
				'count' => 4 
		) );
	}
	...
	public function testRequestWithCrossCookie() {
		...
		), $this->Socket->request ['cookies'] );
		$expected ['www.cakephp.org'] += array (
				'bar' => array (
						'value' => 'foo' 
				) 
		);
	...
	public function testRequestWithRedirectUrlEncoded() {
		...
		$this->Socket->expects ( $this->at ( 3 ) )->method ( 'write' )->with ( $this->logicalAnd ( $this->stringContains ( 'Host: i.cmpnet.com' ), $this->stringContains ( 'GET /techonline/pdf/a.pdf' ) ) );
	...
	public function testGet() {
		...
		$this->RequestSocket->expects ( $this->at ( 0 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
				'uri' => 'http://www.google.com/' 
		) );
		
		$this->RequestSocket->expects ( $this->at ( 1 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
				'uri' => 'http://www.google.com/?foo=bar' 
		) );
		
		$this->RequestSocket->expects ( $this->at ( 2 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
				'uri' => 'http://www.google.com/?foo=bar' 
		) );
		
		$this->RequestSocket->expects ( $this->at ( 3 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
				'uri' => 'http://www.google.com/?foo=23&foobar=42' 
		) );
		
		$this->RequestSocket->expects ( $this->at ( 4 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
				'uri' => 'http://www.google.com/',
				'version' => '1.0' 
		) );
		
		$this->RequestSocket->expects ( $this->at ( 5 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
				'uri' => 'https://secure.example.com/test.php?one=two' 
		) );
		
		$this->RequestSocket->expects ( $this->at ( 6 ) )->method ( 'request' )->with ( array (
				'method' => 'GET',
		...
		$this->RequestSocket->get ( 'http://www.google.com/', array (
				'foo' => 'bar' 
		) );
		$this->RequestSocket->get ( 'http://www.google.com/', 'foo=bar' );
		$this->RequestSocket->get ( 'http://www.google.com/?foo=bar', array (
				'foobar' => '42',
				'foo' => '23' 
		) );
		$this->RequestSocket->get ( 'http://www.google.com/', null, array (
				'version' => '1.0' 
		) );
		$this->RequestSocket->get ( 'https://secure.example.com/test.php', array (
				'one' => 'two' 
		) );
	...
	public function testPost() {
		...
		$this->RequestSocket->post ( 'http://www.google.com/', array (
				'Foo' => 'bar' 
		) );
		$this->RequestSocket->post ( 'http://www.google.com/', null, array (
				'line' => 'Hey Server' 
		) );
	}
	...
	public function testPut() {
		...
		$this->RequestSocket->put ( 'http://www.google.com/', array (
				'Foo' => 'bar' 
		) );
		$this->RequestSocket->put ( 'http://www.google.com/', null, array (
				'line' => 'Hey Server' 
		) );
	}
	...
	public function testDelete() {
		...
		$this->RequestSocket->delete ( 'http://www.google.com/', array (
				'Foo' => 'bar' 
		) );
		$this->RequestSocket->delete ( 'http://www.google.com/', null, array (
				'line' => 'Hey Server' 
		) );
	}
	...
	public function testParseUri() {
		...
		$uri = $this->Socket->parseUri ( 'https://www.cakephp.org', array (
				'scheme' => 'http',
				'port' => 23 
		) );
		$this->assertEquals ( $uri, array (
	...
	public function testParseQuery() {
		...
		$query = $this->Socket->parseQuery ( array (
				'framework' => 'cakephp' 
		) );
		$this->assertEquals ( array (
				'framework' => 'cakephp' 
	...
	public function testBuildHeader() {
		...
		$r = $this->Socket->buildHeader ( array (
				'Host' => 'www.cakephp.org' 
		) );
