...
class Mysql extends DboSource {
	...
	/**
	 * use alias for update and delete.
	 * Set to true if version >= 4.1
	 *
	 * @var boolean
	 */
	...
	public function getEncoding() {
		return $this->_execute ( 'SHOW VARIABLES LIKE ?', array (
	...
	public function getCharsetName($name) {
		...
		$r = $this->_execute ( 'SELECT CHARACTER_SET_NAME FROM INFORMATION_SCHEMA.COLLATIONS WHERE COLLATION_NAME = ?', array (
				$name 
		) );
