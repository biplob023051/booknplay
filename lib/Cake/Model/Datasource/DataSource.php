...
class DataSource extends Object {
	...
	/**
	 * Used to read records from the Datasource.
	 * The "R" in CRUD
	 *
	 * To-be-overridden in subclasses.
	 *
	 ...
	 * are satisfied.
	 * Often used from connect() to check for support
	 ...
	 * @param Model $model
	 *        	Instance of the model to replace $__cakeID__$
	 * @param Model $linkModel
	 *        	Instance of model to replace $__cakeForeignKey__$
	 * @param array $stack        	
