...
class CakeSocket {
	...
	public function connect() {
		...
		$this->connection = stream_socket_client ( $scheme . $this->config ['host'] . ':' . $this->config ['port'], $errNum, $errStr, $this->config ['timeout'], $connectAs, $context );
	 ...
	 * Returns false if no data is available or no connection could be
	 * established.
	 *
