...
if (! function_exists ( 'config' )) {
	 ...
	 * Receives a set of configuration files
	 * to load.
	 * Example:
	 *
...
if (! function_exists ( 'env' )) {
	 ...
	 * for unsupported or inconsistent environment variables (i.e.
	 * DOCUMENT_ROOT on
...
if (! function_exists ( 'clearCache' )) {
	 ...
	 *        	As String name to be searched for deletion, if name is a directory all files in
...
if (! function_exists ( 'stripslashes_deep' )) {
	 ...
	 *
	 * @param array $values
	 *        	Array of values to strip slashes
