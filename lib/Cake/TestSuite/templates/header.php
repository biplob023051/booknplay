...
ul.tests li.pass, ul.tests li.error, ul.tests li.skipped, ul.tests li.fail
	{
	background: #fff2f2 url(<?php echo $baseDir; ?>img/test-fail-icon.png)
		5px 5px no-repeat;
...
<link rel="stylesheet" type="text/css"
	href="<?php echo $baseDir; ?>css/cake.generic.css" />
</head>
<body>
	<div id="container">
		<div id="header">
