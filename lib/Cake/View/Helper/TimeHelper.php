...
class TimeHelper extends AppHelper {
	...
	/**
	 *
	 * @see CakeTime::timeAgoInWords() ## Addition options
	 *     
	...
	public function timeAgoInWords($dateTime, $options = array()) {
		...
		if ($element) {
			$relativeDate = sprintf ( '<%s%s>%s</%s>', $element ['tag'], $this->_parseAttributes ( $element, array (
					'tag' 
			) ), $relativeDate, $element ['tag'] );
		}
		return $relativeDate;
	}
	 ...
	 * @see CakeTime::gmt()
	 *
	 * @param integer|string|DateTime $string
	 *        	UNIX timestamp, strtotime() valid string or DateTime object
	 * @return integer UNIX timestamp
	 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
	 */
