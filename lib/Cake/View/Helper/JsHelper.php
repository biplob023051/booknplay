...
class JsHelper extends AppHelper {
	 ...
	 * @param boolean $top
	 *        	If true the script will be added to the top of the
	 ...
	 * Uses the selected JS engine to create a link
	...
	/**
	 * Pass variables into Javascript.
	 * Allows you to set variables that will be
	 ...
	 * element that is enhanced with Javascript.
	 * Options can include
	...
	public function submit($caption = null, $options = array()) {
		...
		$options ['data'] = $this->serializeForm ( array (
				'isForm' => false,
				'inline' => true 
		) );
		$requestString = $url = '';
