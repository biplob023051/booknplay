...
abstract class JsBaseEngineHelper extends AppHelper {
	 ...
	 * Option maps allow other helpers to use generic names for engine
	...
	/**
	 * Redirects to an URL.
	 * Creates a window.location modification snippet
	 ...
	 * from an array.
	 * Will use native JSON encode method if available, and $useNative == true
	 *
	 * ### Options:
	 *
	 ...
	 * Converts and escapes necessary characters.
	 *
	 * @param string $string
	...
	/**
	 * Add an event to the script cache.
	 * Operates on the currently selected elements.
	 *
	 * ### Options
	 *
	...
	/**
	 * Create a domReady event.
	 * This is a special event in many libraries
	 *
	 ...
	 * Works on the currently selected element.
	 ...
	 * Allows for draggable elements to be dropped on it.
	 * Additional options may be supported by the library implementation.
	 *
	 * ### Options
	 *
	...
	/**
	 * Create a slider UI widget.
	 * Comprised of a track and knob.
	 * Additional options may be supported by the library implementation.
	 *
	 * ### Options
	 *
