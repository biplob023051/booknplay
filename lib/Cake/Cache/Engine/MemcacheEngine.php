...
class MemcacheEngine extends CacheEngine {
	...
	/**
	 * Parses the server address into the host/port.
	 ...
	 * When using memcache as your cache engine
	...
	public function decrement($key, $offset = 1) {
		if ($this->settings ['compress']) {
			throw new CacheException ( __d ( 'cake_dev', 'Method decrement() not implemented for compressed cache in %s', __CLASS__ ) );
		}
