...
class Configure {
	...
	/**
	 * Add a new reader to Configure.
	 * Readers allow you to read configuration
	...
	/**
	 * Remove a configured reader.
	 * This will unset the reader
	...
	/**
	 * Dump data currently in Configure into $key.
	 ...
	 * Internally used by `Configure::load()` and `Configure::dump()`
	...
	/**
	 * Used to write runtime configuration into Cache.
	 * Stored runtime configuration can be
	...
	/**
	 * Restores configuration data stored in the Cache into configure.
	 * Restored
