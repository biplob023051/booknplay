...
class InternalErrorException extends HttpException {
	 ...
	 *
	 * @param string $message
	 *        	If no message is given 'Internal Server Error' will be the message
	 * @param int $code
...
class CakeException extends CakeBaseException {
	 ...
	 *        	Either the string of the error message, or an array of attributes
 ...
 * This exception will be thrown from Router when it
 * encounters an error.
 *
 * @package Cake.Error
 */
...
/**
 * Exception class for CakeLog.
 * This exception will be thrown from CakeLog when it
 * encounters an error.
 *
 * @package Cake.Error
 */
...
/**
 * Exception class for CakeSession.
 * This exception will be thrown from CakeSession when it
 * encounters an error.
 *
 * @package Cake.Error
 */
...
/**
 * Exception class for Configure.
 * This exception will be thrown from Configure when it
 * encounters an error.
 *
 * @package Cake.Error
 */
 ...
 * This exception will be thrown from CakeSocket, CakeEmail, HttpSocket
 ...
 * This exception will be thrown from Xml when it
 * encounters an error.
 *
 * @package Cake.Error
 */
...
/**
 * Exception class for Console libraries.
 * This exception will be thrown from Console library
