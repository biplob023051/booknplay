...
class BenchmarkShell extends Shell {
	 ...
	 *        	If true, calculates an unbiased estimate of the population
	...
	public function getOptionParser() {
		...
		$parser->description ( __d ( 'debug_kit', 'Allows you to obtain some rough benchmarking statistics' . 'about a fully qualified URL.' ) )->addArgument ( 'url', array (
				...
				'default' => 100,
				'help' => __d ( 'debug_kit', 'Maximum total time for all iterations, in seconds.' . 'If a single iteration takes more than the tiemout, only one request will be made' ) 
		) )->epilog ( __d ( 'debug_kit', 'Example Use: `cake benchmark --n 10 --t 100 http://localhost/testsite`. ' . '<info>Note:</info> this benchmark does not include browser render times.' ) );
		return $parser;
	}
}
