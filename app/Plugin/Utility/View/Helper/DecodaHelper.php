...
class DecodaHelper extends AppHelper {
	...
	public function __construct(View $view, $settings = array()) {
		...
		// Custom config
		$decoda->addHook ( new \Decoda\Hook\EmoticonHook ( array (
				'path' => '/utility/img/emoticon/' 
		) ) );
	...
	/**
	 * Execute setupDecoda() if it exists.
	 * This allows for custom filters and hooks to be applied.
	 *
